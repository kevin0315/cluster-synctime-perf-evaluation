...
(function() {
  ...
  if (el1) {
    ...
    chart1.setOption({
      ...
      legend: Object.assign(baseLegend(), {
        data: ['外网 NTP', '本地 NTP', '直连 NTP'],
        top: 0,
        textStyle: { color: muted, fontSize: 11 },
        itemWidth: 12,
        itemHeight: 6
      }),
      grid: Object.assign(baseGrid(), { top: '20%' }),
      ...
      series: [
        {
          ...
          label: {
            show: true, position: 'top',
            color: accent2, fontSize: 11, fontWeight: 700,
            formatter: '{c}%'
          }
        },
        {
        ...
        },
        {
          ...
          label: {
            show: true, position: 'top',
            color: accent3, fontSize: 11, fontWeight: 700,
            formatter: function(p) {
              if (p.value === '-' || p.value == null) return '';
              return p.value + '%';
            }
  ...
  if (el4) {
    ...
    chart4.setOption({
      ...
      grid: Object.assign(baseGrid(), { top: '20%', left: '10%', right: '12%' }),
